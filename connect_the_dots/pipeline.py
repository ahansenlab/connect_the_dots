"""
Functions for the data analysis pipeline of connect_the_dots.
"""
...
def get_localizations_iterative(filtered_zstack_timeseries, 
    ...
    percentile_threshold_increment : float
        Increment added to `percentile_threshold` if trajectory creation fails by `min_dot_size_increment`.
